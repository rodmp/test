...
@XmlRootElement(name = "TypeResource")
public class TypeResource {

    protected int slot;
    @XmlElement(name = "Type", required = true)
    protected TypeResource.Type type;
     ...
     * @return
     *     possible object is
     *     {@link TypeResource.Type }
     *     
     */
    public TypeResource.Type getType() {
        return type;
    }
     ...
     *     
     */
    public void setType(TypeResource.Type value) {
        this.type = value;
    }
